...
removal_list = ["_电信", "电信", "高清", "频道", "（HD）", "-HD","英陆","_ITV","(北美)","(HK)","AKtv","「IPV4」","「IPV6」",
                ...
                "粤陆", "国陆","肆柒","频英","频特","频国","频壹","频贰","肆贰","频测","咪咕","@","[ipv6]","[ipv4]"]
    ...
    if  "#genre#" not in line and "#EXTINF:" not in line and "," in line and "://" in line:
        ...
        if channel_address not in combined_blacklist: # 判断当前源是否在blacklist中
            ...
            if "CCTV" in channel_name and check_url_existence(ys_lines, channel_address) : #央视频道
                ...
                mdd_lines.append(process_name_string(line.strip()))
...
all_lines_simple =  ["更新时间,#genre#"] + [version] + ['\n'] +\
             ...
             ["明星,#genre#"] + sort_data(mx_dictionary,set(correct_name_data(mx_lines))) + ['\n'] + \
             ["主题片,#genre#"] + sort_data(ztp_dictionary,set(correct_name_data(ztp_lines))) + ['\n'] + \
